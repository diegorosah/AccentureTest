...
public class AccentureTest {
	...
	public void na_aba_send_quote() {
		...
		driver.findElement(By.id("username")).sendKeys("diegooooo");
		driver.findElement(By.id("password")).sendKeys("F@1234a");
		driver.findElement(By.id("confirmpassword")).sendKeys("F@1234a");
		driver.findElement(By.id("Comments")).sendKeys("diegorosah.hc2@gmail.com");
	...
	public void na_aba_enter_insurant_data() {
		...
		driver.findElement(By.id("birthdate")).sendKeys("06/07/1991");
		driver.findElement(By.cssSelector(".group:nth-child(2) > .ideal-radiocheck-label:nth-child(1) > .ideal-radio"))
				.click();
		driver.findElement(By.id("streetaddress")).sendKeys("R. Major Freire, 578");
		...
		driver.findElement(By.id("zipcode")).sendKeys("04304110");
		driver.findElement(By.cssSelector(".idealsteps-step:nth-child(2)")).click();
		...
		driver.findElement(By.id("picturecontainer"))
				.sendKeys(System.getProperty("user.dir") + File.separator + "imgs" + File.separator + "batman.jpeg");
